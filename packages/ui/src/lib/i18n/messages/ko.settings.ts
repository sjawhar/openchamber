...
'settings.remoteInstances.clientAuth.actions.addDevice': '기기 추가',
  ...
  'settings.openchamber.mobileLanding.title': '모바일 시작 화면',
  'settings.openchamber.mobileLanding.recents.label': '최근 세션으로 열기',
  'settings.openchamber.mobileLanding.recents.description': '휴대폰에서는 열린 세션이 없을 때 새 세션 초안 대신 프로젝트 전체의 최근 세션 목록을 표시합니다.',
