...
"settings.remoteInstances.clientAuth.actions.addDevice": "Añadir un dispositivo",
  ...
  "settings.openchamber.mobileLanding.title": "Inicio móvil",
  "settings.openchamber.mobileLanding.recents.label": "Abrir en sesiones recientes",
  "settings.openchamber.mobileLanding.recents.description": "En teléfonos, muestra la lista de sesiones recientes de todos los proyectos cuando no hay ninguna sesión abierta, en lugar de un borrador de sesión nueva.",
