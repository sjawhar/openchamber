...
'settings.remoteInstances.clientAuth.actions.addDevice': '添加设备',
  ...
  'settings.openchamber.mobileLanding.title': '移动端起始页',
  'settings.openchamber.mobileLanding.recents.label': '打开最近会话',
  'settings.openchamber.mobileLanding.recents.description': '在手机上，当没有打开任何会话时，显示跨项目的最近会话列表，而不是新会话草稿。',
