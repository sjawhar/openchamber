export const settingsDict = {
  ...
  'settings.openchamber.mobileLanding.recents.description': 'Na telefonach, gdy żadna sesja nie jest otwarta, wyświetla listę ostatnich sesji ze wszystkich projektów zamiast szkicu nowej sesji.',
  'settings.openchamber.mobileLanding.recents.label': 'Otwieraj ostatnie sesje',
  'settings.openchamber.mobileLanding.title': 'Ekran startowy na urządzeniach mobilnych',
